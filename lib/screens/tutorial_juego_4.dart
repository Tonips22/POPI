...
class TutorialJuego4Screen extends StatefulWidget {
  const TutorialJuego4Screen({super.key});

  @override
  State<TutorialJuego4Screen> createState() => _TutorialJuego4ScreenState();
}

class _TutorialJuego4ScreenState extends State<TutorialJuego4Screen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Tutorial - Deja el mismo número'),
        leading: IconButton(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Quita bolas de cada recipiente hasta que todos tengan la misma cantidad. '
                'Piensa bien antes de quitar para no pasarte.',
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: const [
                      ...
                      SizedBox(height: 16),
                      _TutorialTip(text: 'Observa cuántas bolas tiene cada jarra.'),
                      _TutorialTip(
                        text: 'Quita solo las necesarias para igualarlas.',
                      ),
                      _TutorialTip(
                        text: 'Si te sobra una bola, colócala de nuevo con cuidado.',
                      ),
                    ],
                  ),
                ),
