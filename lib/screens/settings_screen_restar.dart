...
import 'restar_difficulty_screen.dart';
import 'customization_screen.dart';
import '../services/app_service.dart';

class SettingsScreenRestar extends StatelessWidget {
  const SettingsScreenRestar({super.key});
              ...
              _SettingsOptionCard(
                ...
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => const RestarDifficultyScreen(),
                    ),
                  );
                },
              ),
