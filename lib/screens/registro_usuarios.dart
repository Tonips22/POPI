...
import '../models/user_profile.dart';  // <-- MODELO CORRECTO
...
class _RegistroUsuariosScreenState extends State<RegistroUsuariosScreen> {
  ...
  // Colores consistentes con admin
    ...
    return Scaffold(
      ...
      body: _isLoading
        ...
        builder: (context, c) {
          ...
          final colIdW = totalWidth * 0.25;
          final colNameW = totalWidth * 0.25;
          final colRoleW = totalWidth * 0.20;
          final colDateW = totalWidth -
              (colAvatarW + colIdW + colNameW + colRoleW + colGap * 4);
                  ...
                  SizedBox(
                    ...
                    child: Center(
                      child: Container(
                        ...
                        child: Text(emoji,
                            style:
                            TextStyle(fontSize: avatar * 0.58)),
                      ),
                    ),
                  ),
                  SizedBox(width: colGap),
